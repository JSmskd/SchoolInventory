...
struct BarcodeView: View {
    ...
    @EnvironmentObject var vm : BarcodeAppViewModel
    ...
    private var mainView: some View {
            BarcodeDataScannerView(
                ...
                recognizesMultipleItems: vm.recognizesMultipeItems)
            .background { Color.gray.opacity(0.3) }
            .ignoresSafeArea()
            .id(vm.dataScannerViewerId)
        ...
        .onChange(of: vm.recognizesMultipeItems) { _ in vm.recognizedItems = [] }
    }
